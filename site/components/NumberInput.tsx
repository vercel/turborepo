...
export function NumberInput(
  ...
  return (
    <div>
      ...
      <div
        className="mt-1 rounded-md shadow-sm  bg-opacity-5 flex border dark:border-transparent "
        {...groupProps}
      >
        ...
        {!props.isDisabled && (
          <>
            <div className="-ml-px relative text-dark flex flex-col divide-y dark:divide-gray-900  text-sm font-medium rounded-r-md  bg-gray-50 bg-opacity-10 border-l dark:bg-opacity-5 dark:border-black dark:divide-black ">
              <button
