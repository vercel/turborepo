...
export function Footer2({ showCta = true }: Footer2Props) {
  ...
  return (
    <>
      {showCta ? (
        <div className="dark:bg-gray-900 dark:bg-opacity-5 bg-gray-100 border-t border-b dark:border-gray-900">
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 text-center lg:text-left dark:lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
        ...
        <div className="max-w-screen-xl mx-auto py-12 px-4 overflow-hidden space-y-8 sm:px-6 lg:px-8">
          <nav className="-mx-5 -my-2 flex flex-wrap justify-center">
            <div className="px-5 py-2">
              <Link href="/">
                <a className="text-base leading-6 text-gray-500 betterhover:hover:text-gray-900 dark:betterhover:hover:text-gray-600 duration-100 transition ease-in-out">
                  About
                </a>
              </Link>
            </div>
            <div className="px-5 py-2">
              <a
                ...
                target="_blank"
                className="text-base leading-6 text-gray-500 betterhover:hover:text-gray-900 dark:betterhover:hover:text-gray-600 duration-100 transition ease-in-out"
              >
                Roadmap
              </a>
            </div>
          ...
          <p className="mt-8 text-center text-sm leading-6 text-gray-600">
            Copyright © 2021 SLP Media Productions LLC. All rights reserved.
          </p>
        </div>
      </footer>
    </>
