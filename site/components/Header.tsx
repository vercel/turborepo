...
export function Header() {
  ...
  return (
    <>
      <div className="dark:bg-gray-900  dark:bg-opacity-5 bg-white py-5 flex items-center">
        <div className="text-gray-900">
          <Link href="/">
            <a className="flex items-center text-gray-800 text-xl font-bold uppercase tracking-widest">
        ...
        <div className=" flex-grow flex items-center justify-end">
          {/* spacer */}
          {/* <a className="mr-6 font-semibold text-gray-700 betterhover:hover:text-green-600 transition ease-in-out duration-150">
            Blog
          </a> */}
          <Link href="/#demo">
            <a className="cta px-4 py-2 font-semibold">Get a Live Demo</a>
          </Link>
        </div>
        {/* <Link href="/blog">
          <a className="mr-6 font-semibold text-gray-700 betterhover:hover:text-green-600 transition ease-in-out duration-150">
