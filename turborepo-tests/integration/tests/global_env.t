...
# run the first time to get basline hash
  ...
  util:build: cache miss, executing e6ceb7aa9a6948f8
...
# run again and ensure there's a cache hit
  ...
  \xe2\x80\xa2 Running build in 1 packages (esc)
  \xe2\x80\xa2 Remote caching disabled (esc)
  util:build: cache hit, suppressing output e6ceb7aa9a6948f8
...
# set global env var and ensure cache miss
  ...
  \xe2\x80\xa2 Running build in 1 packages (esc)
  \xe2\x80\xa2 Remote caching disabled (esc)
  util:build: cache miss, executing f0c717cd3cc7ad25
...
# set vercel analytics env var and ensure cache miss
  ...
  \xe2\x80\xa2 Running build in 1 packages (esc)
  \xe2\x80\xa2 Remote caching disabled (esc)
  util:build: cache miss, executing b92089171e347837
