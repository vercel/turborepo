...
mod tests {
    ...
    fn test_parse_package_manager_string() {
        let tests = vec![
            ...
            TestCase {
                ...
                package_manager: Spanned::new("utoo@1.1.8".to_owned()),
                expected_manager: "utoo".to_owned(),
                expected_version: "1.1.8".to_owned(),
                expected_error: false,
            },
            TestCase {
    ...
    fn test_read_package_manager() -> Result<(), Error> {
        ...
        package_json.package_manager = Some(Spanned::new("utoo@1.1.8".to_string()));
        let package_manager = PackageManager::read_package_manager(repo_root, &package_json)?;
        assert_eq!(
            package_manager,
            PackageManager::Utoo {
    ...
    #[test_case("utoo", "1.1.8", PackageManager::Utoo { lockfile: Box::new(PackageManager::Npm) } ; "utoo")]
