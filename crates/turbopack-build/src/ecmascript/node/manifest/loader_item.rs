...
#[turbo_tasks::function]
fn build_manifest_loader_chunk_reference_description() -> StringVc {
    StringVc::cell("build manifest loader chunk".to_string())
}
...
impl ChunkItem for BuildManifestLoaderItem {
    ...
    async fn references(&self) -> Result<AssetReferencesVc> {
        Ok(AssetReferencesVc::cell(vec![SingleAssetReferenceVc::new(
            ...
            build_manifest_loader_chunk_reference_description(),
        )
        .into()]))
    }
}
