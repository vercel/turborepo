...
graph TD
    ...
    N11["Items: [ItemId(ModuleEvaluation), ItemId(1, ImportBinding(0)), ItemId(4, VarDeclarator(0)), ItemId(9, Normal), ItemId(6, VarDeclarator(0)), ItemId(8, Normal), ItemId(10, Normal)]"];
    N12["Items: [ItemId(Export((Atom('external1' type=dynamic), #0))), ItemId(0, Normal)]"];
    N13["Items: [ItemId(Export((Atom('foobar' type=inline), #0))), ItemId(2, VarDeclarator(0)), ItemId(5, Normal), ItemId(7, Normal)]"];
    N14["Items: [ItemId(Export((Atom('foo' type=inline), #0))), ItemId(3, VarDeclarator(0))]"];
