...
graph TD
    ...
    N9["Items: [ItemId(4, Normal), ItemId(3, VarDeclarator(0))]"];
    N10["Items: [ItemId(5, VarDeclarator(0))]"];
    N11["Items: [ItemId(6, Normal)]"];
    N12["Items: [ItemId(7, Normal), ItemId(0, ImportOfModule), ItemId(2, VarDeclarator(0)), ItemId(9, Normal), ItemId(0, ImportBinding(0)), ItemId(1, VarDeclarator(0)), ItemId(4, Normal), ItemId(6, Normal)]"];
