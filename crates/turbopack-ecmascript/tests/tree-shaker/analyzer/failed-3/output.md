...
- Hoisted
- Declares: `createIpc`
- Reads (eventual): `createConnection`, `JSON`, `Buffer`, `process`, `Promise`, `structuredError`, `console`
...
- Reads (eventual): `console`, `process`, `Error`
...
graph TD
    ...
    N4["Items: [ItemId(0, ImportBinding(0)), ItemId(4, Normal)]"];
