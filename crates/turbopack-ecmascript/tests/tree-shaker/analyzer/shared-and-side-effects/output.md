...
```mermaid
graph TD
    N0["Items: [ItemId(ModuleEvaluation), ItemId(0, Normal), ItemId(1, VarDeclarator(0)), ItemId(2, VarDeclarator(0)), ItemId(3, Normal), ItemId(4, VarDeclarator(0)), ItemId(6, Normal)]"];
