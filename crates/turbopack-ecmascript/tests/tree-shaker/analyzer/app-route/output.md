...
- Reads: `AppRouteRouteModule`, `nextConfigOutput`, `userland`
...
graph TD
    ...
    N11["Items: [ItemId(0, ImportBinding(0)), ItemId(2, ImportBinding(0)), ItemId(3, ImportBinding(0)), ItemId(4, VarDeclarator(0))]"];
