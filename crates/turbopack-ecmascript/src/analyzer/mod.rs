...
use turbopack_core::{compile_time_info::CompileTimeDefineValue, number::ConstantNumber};
use url::Url;
...
impl From<&CompileTimeDefineValue> for JsValue {
    fn from(v: &CompileTimeDefineValue) -> Self {
        match v {
            ...
            CompileTimeDefineValue::Number(n) => JsValue::Constant(ConstantNumber(n.into())),
        }
    }
}
