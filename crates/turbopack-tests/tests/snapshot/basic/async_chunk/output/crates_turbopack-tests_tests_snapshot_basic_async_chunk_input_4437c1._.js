...
__turbopack_require__("[project]/crates/turbopack-tests/tests/snapshot/basic/async_chunk/input/import.js [test] (ecmascript, loader)")(__turbopack_import__).then(({ foo })=>{
    foo(true);
});
