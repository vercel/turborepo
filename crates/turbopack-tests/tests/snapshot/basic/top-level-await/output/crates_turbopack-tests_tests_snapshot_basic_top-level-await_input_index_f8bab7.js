(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["output/crates_turbopack-tests_tests_snapshot_basic_top-level-await_input_index_f8bab7.js", {
...
const UserApi = __turbopack_require__("[project]/crates/turbopack-tests/tests/snapshot/basic/top-level-await/input/UserAPI.js (ecmascript, loader)")(__turbopack_import__);
...
const AlternativeCreateUserAction = async (name)=>{
    const { createUser } = await __turbopack_require__("[project]/crates/turbopack-tests/tests/snapshot/basic/top-level-await/input/UserAPI.js (ecmascript, loader)")(__turbopack_import__);
    await createUser(name);
...
"[project]/crates/turbopack-tests/tests/snapshot/basic/top-level-await/input/UserAPI.js (ecmascript, loader)": (({ r: __turbopack_require__, f: __turbopack_require_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, l: __turbopack_load__, j: __turbopack_dynamic__, g: global, __dirname }) => (() => {

__turbopack_export_value__((__turbopack_import__) => {
    return Promise.all(["output/crates_turbopack-tests_tests_snapshot_basic_top-level-await_input_UserAPI_51a291.js","output/crates_turbopack-tests_tests_snapshot_basic_top-level-await_input_UserAPI_35b556.js"].map((chunk) => __turbopack_load__(chunk))).then(() => {
...
//# sourceMappingURL=crates_turbopack-tests_tests_snapshot_basic_top-level-await_input_index_f8bab7.js.map