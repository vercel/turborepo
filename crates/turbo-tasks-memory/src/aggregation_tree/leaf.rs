...
impl<T, I: Clone + Eq + Hash + IsEnabled> AggregationTreeLeaf<T, I> {
    ...
    pub fn remove_child<C: AggregationContext<Info = T, ItemRef = I>>(
        ...
        let _span = tracing::trace_span!("aggregation_tree leaf remove_child").entered();
        self.upper
            .as_cloned_uppers()
    ...
    pub fn get_root_info<C: AggregationContext<Info = T, ItemRef = I>>(
        ...
        let _span = tracing::trace_span!("aggregation_tree leaf get_root_info").entered();
...
pub fn bottom_tree<C: AggregationContext>(
    ...
    let mut result = None;
    {
        ...
        _span = (height > 1).then(|| tracing::trace_span!("bottom_tree", height).entered());
