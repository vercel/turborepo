...
pub fn value_trait(args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    for item in raw_items.iter() {
        ...
        let default = if let Some(block) = default {
            ...
            let inline_function_path: ExprPath = parse_quote! { <&dyn #trait_ident as #inline_extension_trait_ident>::#inline_function_ident };
            ...
            native_functions.push(quote! {
                ...
                #[doc(hidden)]
                // #[turbo_tasks::async_trait]
                impl #inline_extension_trait_ident for &dyn #trait_ident {
                    #[allow(declare_interior_mutable_const)]
                ...
                #[doc(hidden)]
                pub(crate) static #native_function_ident: #native_function_ty = <&dyn #trait_ident as #inline_extension_trait_ident>::#native_function_ident;
                #[doc(hidden)]
                pub(crate) static #native_function_id_ident: #native_function_id_ty = <&dyn #trait_ident as #inline_extension_trait_ident>::#native_function_id_ident;
            });
    ...
    let expanded = quote! {
        ...
        pub(crate) static #trait_type_ident: turbo_tasks::macro_helpers::Lazy<turbo_tasks::TraitType> =
            turbo_tasks::macro_helpers::Lazy::new(|| {
                let mut trait_type = turbo_tasks::TraitType::new(std::any::type_name::<turbo_tasks::Vc<&dyn #trait_ident>>().to_string());;
        ...
        impl turbo_tasks::VcValueTrait for &dyn #trait_ident {
            fn get_trait_type_id() -> turbo_tasks::TraitTypeId {
                *#trait_type_id_ident
            }
        }

        unsafe impl turbo_tasks::Dynamic<&dyn #trait_ident> for &dyn #trait_ident {}

        impl<T> #trait_ident for T
        where
            for<'a> T: turbo_tasks::Dynamic<&'a dyn #trait_ident> #(+ #supertraits)*,
        {
            #(#dynamic_trait_fns)*
        }

        #(
            unsafe impl turbo_tasks::Dynamic<&dyn #supertraits> for &dyn #trait_ident {}
            unsafe impl turbo_tasks::Upcast<&dyn #supertraits> for &dyn #trait_ident {}
        )*
