...
- When an automated schedule produces changes, create a draft pull request with `create_pull_request`. Use an `agents/weekly-examples-YYYY-MM-DD` branch, a Conventional Commit title, and include the validation results in the pull request body.
