...
<Tab value="aube">
  <Files>
    <File name="package.json" green />
    <File name="aube-lock.yaml" green />
    <File name="turbo.json" />
    <Folder name="apps" defaultOpen>
      <Folder name="docs" className="text-foreground" defaultOpen>
        <File name="package.json" green />
...
<Tab value="nub">
  ...
  <LinkToDocumentation href="https://nub.dev" text="nub documentation" />
  </Tab>

<Tab value="aube">

```yaml title="aube-workspace.yaml"
packages:
  - "apps/*"
  - "packages/*"
```

  <LinkToDocumentation href="https://aube.jdx.dev" text="aube workspace documentation" />
  </Tab>
