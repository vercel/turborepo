...
<LinkToDocumentation href="https://aube.jdx.dev" text="aube documentation" />
</Tab>
...
<small>[-> nub documentation](https://nub.dev)</small>
...
<small>[-> aube documentation](https://aube.jdx.dev)</small>
