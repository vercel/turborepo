...
| Affected base ref                 | [`--base`](/docs/reference/run#--base)                                                                           | [`TURBO_SCM_BASE`](/docs/reference/system-environment-variables#turbo_scm_base)                                                                   | -                                                                                                              |
| Affected head ref                 | [`--head`](/docs/reference/run#--head)                                                                           | [`TURBO_SCM_HEAD`](/docs/reference/system-environment-variables#turbo_scm_head)                                                                   | -                                                                                                              |
