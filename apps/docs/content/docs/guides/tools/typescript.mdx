...
If your workspace has decided to adopt Project References anyway, use [`@turbo/typescript`](/docs/reference/turbo-typescript) to keep the root and package references synchronized with your package graph.
