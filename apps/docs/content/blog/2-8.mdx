...
product: turborepo
type: overview
summary: Release notes for Turborepo 2.8 featuring Git worktree support, Agent Skill, and AI-enabled documentation.
tag: "web development"
---
...
- [**`turbo docs`**](#turbo-docs-subcommand): Search documentation directly from your terminal
