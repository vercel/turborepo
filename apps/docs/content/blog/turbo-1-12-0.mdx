...
product: turborepo
type: overview
summary: Release notes for Turborepo 1.12 featuring colored task logs, improved errors, and telemetry.
tag: "web development"
---
...
import ColorsInLogsLight from "../../public/images/blog/turbo-1-12-0/log-colors-light.png";
import ColorsInLogsDark from "../../public/images/blog/turbo-1-12-0/log-colors-dark.png";
import ErrorsOverhaulLight from "../../public/images/blog/turbo-1-12-0/light-errors-overhaul.png";
import ErrorsOverhaulDark from "../../public/images/blog/turbo-1-12-0/errors-overhaul-dark.png";
...
We're creating the build system of the future and this information will be highly valuable to guide us in that effort. For more information, visit [turborepo.dev/docs/telemetry](https://turborepo.dev/docs/telemetry).
