...
product: turborepo
type: overview
summary: Release notes for Turborepo 2.7 featuring Devtools, composable configuration, and Yarn 4 catalogs.
tag: "web development"
---
...
import DevtoolsImageDark from "../../public/images/blog/turbo-2-7/devtools-dark.png";
import DevtoolsImageLight from "../../public/images/blog/turbo-2-7/devtools-light.png";
...
We’ve shipped a brand new experience at [turborepo.dev/devtools](http://turborepo.dev/devtools). Starting with this version of Turborepo, you can run `turbo devtools` to visually explore your Package Graph and Task Graph.

<ThemeAwareImage
  className="my-4 flex justify-center"
  light={{
    alt: "",
    src: DevtoolsImageLight,
    props: {
      width: 1600,
      height: 750,
...
And much, much more. Visit [turborepo.dev/devtools](http://turborepo.dev/devtools) to get started, or [learn more in the documentation](/docs/reference/devtools).
...
[Visit the docs to learn more.](/docs/reference/package-configurations#extending-from-other-packages)
...
In [Biome 2.3.10](https://github.com/biomejs/biome/releases/tag/%40biomejs%2Fbiome%402.3.10) and above, you can find environment variables that can cause unexpected cache hits faster with [the new Turborepo domain](https://biomejs.dev/linter/domains/#turborepo) in Biome.
