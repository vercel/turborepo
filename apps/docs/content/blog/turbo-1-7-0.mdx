...
product: turborepo
type: overview
summary: Release notes for Turborepo 1.7 featuring improved task clarity and developer experience.
date: "2023/01/11"
tag: "web development"
---
...
<ThemeAwareImage
  light={{
    alt: "Turborepo inference diagram showing how turbo finds your local turbo version",
    src: TurboInferenceImage,
...
Since releasing [Turborepo v1.6](/blog/turbo-1-6-0) and merging with [Turbopack](https://turborepo.dev/pack), we've seen incredible adoption and community growth:
