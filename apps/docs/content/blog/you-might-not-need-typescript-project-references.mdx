...
product: turborepo
type: overview
summary: An internal packages pattern that eliminates the need for TypeScript project references.
date: "2021/04/23"
tag: "web development"
...
Shameless plug here. If you are reading this post, and you're struggling with slow build and test times, I'd love to show you how Turborepo can help. I guarantee that Turborepo will cut your monorepo's build time by 50% or more. [You can request a live demo right here.](https://vercel.com/contact/sales?utm_source=turborepo.dev&utm_medium=referral&utm_campaign=blog-project-references)
