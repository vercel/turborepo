...
product: turborepo
type: overview
summary: Release notes for Turborepo 2.0 featuring a new terminal UI, Watch Mode, and all-new documentation.
tag: "web development"
---
...
import UiGif from "../../public/images/blog/turbo-2-0/interactive-ui.gif";
...
<ThemeAwareImage
  ...
  light={{
    alt: "The new terminal UI",
    src: UiGif,
    props: {
      width: 928,
      height: 522,
      className: "dark:hidden block rounded",
    },
  }}
  dark={{
    alt: "The new terminal UI",
