...
product: turborepo
type: overview
summary: Release notes for Turborepo 1.9 featuring improved task run observability and caching insights.
date: "2023/04/11"
tag: "web development"
---
...
When this flag is enabled, Turborepo will generate a summary in `.turbo/runs/` that contains all the information necessary to understand how `turbo` interpreted your task's configuration and code.
