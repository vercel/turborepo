...
product: turborepo
type: overview
summary: Release notes for Turborepo 1.13 featuring a new terminal UI, turbo scan, and CI logging improvements.
tag: "web development"
---
...
import ExperimentalUiGif from "../../public/images/blog/turbo-1-13-0/experimental-ui.gif";
import TurboScanDark from "../../public/images/blog/turbo-1-13-0/turbo-scan-dark.png";
import TurboScanLight from "../../public/images/blog/turbo-1-13-0/turbo-scan-light.png";
import GitHubActionImage from "../../public/images/blog/turbo-1-13-0/github-action.png";
...
<ThemeAwareImage
  ...
  light={{
    alt: "The new experimental terminal UI",
    src: ExperimentalUiGif,
    props: {
      width: 800,
      height: 350,
...
<ThemeAwareImage
  ...
  dark={{
    ...
    props: {
      width: 1868,
      height: 1800,
      className: "hidden dark:block rounded-xl dark:border-gray-700",
    },
  }}
/>
