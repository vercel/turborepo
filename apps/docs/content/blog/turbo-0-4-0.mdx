...
product: turborepo
type: overview
summary: Release notes for Turborepo 0.4.0 featuring a Go rewrite, smarter hashing, and pruned workspaces.
tag: "web development"
date: "2021/04/02"
...
import TurboSchedulerImage from "../../public/images/blog/turbo-0-4-0/turbo-vs-lerna-execution.png";
...
<ThemeAwareImage
  light={{
    alt: "Turborepo scheduler compared to Lerna execution",
    src: TurboSchedulerImage,
