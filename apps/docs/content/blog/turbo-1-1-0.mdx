...
product: turborepo
type: overview
summary: Release notes for Turborepo 1.1 featuring automatic migrations, turbo.json, and environment variable dependencies.
date: "2022/01/31"
tag: "web development"
---
...
import NpmDownloadsImage from "../../public/images/blog/turbo-1-1-0/turborepo-weekly-npm-downloads.png";
...
- 585+ members of the [Turborepo Community Discord](https://turborepo.dev/discord)

<ThemeAwareImage
  light={{
    alt: "Weekly npm downloads of turbo",
    src: NpmDownloadsImage,
