...
product: turborepo
type: overview
summary: Release notes for Turborepo 2.1 featuring affected package detection and repository exploration tools.
tag: "web development"
---
...
In Turborepo 2.0, we released a [new terminal UI](https://turborepo.dev/blog/turbo-2-0#new-terminal-ui) to improve clarity for logs and allow for interactive tasks in local development. We heard your feedback, and prioritized polishing this UI, releasing improvements in patches to 2.0 and in this 2.1 release:
