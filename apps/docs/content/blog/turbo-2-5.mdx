...
product: turborepo
type: overview
summary: Release notes for Turborepo 2.5 featuring sidecar tasks, turbo.jsonc, and Bun pruning.
tag: "web development"
---
...
We’ve published [the Remote Cache spec as JSON to the web](/api/remote-cache-spec) for some time, and have recently added a human-friendly version of the spec at [https://turborepo.dev/docs/openapi](https://turborepo.dev/docs/openapi).
