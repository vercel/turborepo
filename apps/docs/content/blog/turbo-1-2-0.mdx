...
product: turborepo
type: overview
summary: Release notes for Turborepo 1.2 featuring task filtering, artifact signing, and dry run support.
date: "2022/04/08"
tag: "web development"
---
...
import TurboDryRunImage from "../../public/images/blog/turbo-1-2-0/turbo-dry-run.png";
...
- **95+** OSS contributors
- **900+** members of the [Turborepo Community Discord](https://turborepo.dev/discord)
...
<div className="overflow-hidden lg:rounded-xl">
  <ThemeAwareImage
    light={{
      alt: "Turborepo Dry Run output showing task information",
      src: TurboDryRunImage,
...
{
  "$schema": "[https://turborepo.dev/schema.json](https://turborepo.dev/schema.json)",
  "remoteCache": {
