...
product: turborepo
type: overview
summary: Release notes for Turborepo 1.4 featuring automatic environment variable inclusion and eslint-config-turbo.
date: "2022/08/09"
tag: "web development"
---
...
Since releasing [Turborepo v1.3 in June](https://turborepo.dev/blog/turbo-1-3-0), we've seen incredible adoption and community growth:
