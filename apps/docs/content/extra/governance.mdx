...
product: turborepo
type: overview
summary: Governance structure and team information for the Turborepo open-source project.
---
...
- **Stable**: When the features reach stability, it is considered ready for production use. APIs marked as stable will only change in a backward-compatible way unless there is a major release.
