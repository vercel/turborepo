...
- `next-web`: a [Next.js](https://nextjs.org/) app
- `svelte-web`: a [SvelteKit](https://kit.svelte.dev/) app
...
Once deployed you will need to copy the `packages/database/.env.example` file to `packages/database/.env` in order for Prisma to have a `DATABASE_URL` environment variable to access.
