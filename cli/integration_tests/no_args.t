...
Make sure exit code is 2 when no args are passed
  ...
  Run Arguments:
        ...
        --log-order <LOG_ORDER>          Set type of process output order. Use "stream" to show output as soon as it is available. Use "grouped" to show output when a command has finished execution. (default stream) [possible values: stream, grouped]
