...
Make sure we use local and do not pass --skip-infer to old binary
  ...
  [-0-9:.TWZ+]+ \[DEBUG] turborepo_lib::shim: No local turbo binary found at: .*/nested.t/node_modules/turbo-darwin-arm64/bin/turbo (re)
  [-0-9:.TWZ+]+ \[DEBUG] turborepo_lib::shim: Local turbo path: .*/nested.t/node_modules/turbo/node_modules/turbo-darwin-arm64/bin/turbo (re)
  ...
  [-0-9:.TWZ+]+ \[DEBUG] turborepo_lib::shim: Running local turbo binary in .*/nested.t/node_modules/turbo/node_modules/turbo-darwin-arm64/bin/turbo (re)
