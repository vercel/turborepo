...
Make sure we use local and do not pass --skip-infer to old binary
  ...
  [-0-9:.TWZ+]+ \[DEBUG] turborepo_lib::shim: No local turbo binary found at: .*/linked.t/node_modules/turbo-darwin-arm64/bin/turbo (re)
  [-0-9:.TWZ+]+ \[DEBUG] turborepo_lib::shim: No local turbo binary found at: .*/linked.t/node_modules/turbo/node_modules/turbo-darwin-arm64/bin/turbo (re)
  [-0-9:.TWZ+]+ \[DEBUG] turborepo_lib::shim: Local turbo path: .*/linked.t/node_modules/.pnpm/turbo-darwin-arm64@1.0.0/node_modules/turbo-darwin-arm64/bin/turbo (re)
  ...
  [-0-9:.TWZ+]+ \[DEBUG] turborepo_lib::shim: Running local turbo binary in .*/linked.t/node_modules/.pnpm/turbo-darwin-arm64@1.0.0/node_modules/turbo-darwin-arm64/bin/turbo (re)
