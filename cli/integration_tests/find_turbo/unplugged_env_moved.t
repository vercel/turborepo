...
Make sure we use local and do not pass --skip-infer to old binary
  ...
  [-0-9:.TWZ+]+ \[DEBUG] turborepo_lib::shim: No local turbo binary found at: .*/unplugged_env_moved.t/node_modules/turbo-darwin-arm64/bin/turbo (re)
  [-0-9:.TWZ+]+ \[DEBUG] turborepo_lib::shim: No local turbo binary found at: .*/unplugged_env_moved.t/node_modules/turbo/node_modules/turbo-darwin-arm64/bin/turbo (re)
  [-0-9:.TWZ+]+ \[DEBUG] turborepo_lib::shim: Local turbo path: .*/unplugged_env_moved.t/.moved/unplugged/turbo-darwin-arm64-npm-1.0.0-520925a700/node_modules/turbo-darwin-arm64/bin/turbo (re)
  ...
  [-0-9:.TWZ+]+ \[DEBUG] turborepo_lib::shim: Running local turbo binary in .*/unplugged_env_moved.t/.moved/unplugged/turbo-darwin-arm64-npm-1.0.0-520925a700/node_modules/turbo-darwin-arm64/bin/turbo (re)
