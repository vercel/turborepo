...
Check
  ...
  build: cache miss, executing 02cd45da7a08ba05
  build: 
  build: > build
  build: > echo 'building' > foo
  build: 
  test: cache miss, executing 6aadbf9bca4ae1e0
  test: 
  test: > test
...
Run a second time, verify caching works because there is a config
  ...
  \xe2\x80\xa2 Running test (esc)
  \xe2\x80\xa2 Remote caching disabled (esc)
  build: cache hit, replaying output 02cd45da7a08ba05
  build: 
  build: > build
  build: > echo 'building' > foo
  build: 
  test: cache hit, replaying output 6aadbf9bca4ae1e0
  test: 
  test: > test
  test: > [[ ( -f foo ) && $(cat foo) == 'building' ]]
  test: 
...
Run with --output-logs=hash-only
  ...
  \xe2\x80\xa2 Running test (esc)
  \xe2\x80\xa2 Remote caching disabled (esc)
  build: cache hit, suppressing output 02cd45da7a08ba05
  test: cache hit, suppressing output 6aadbf9bca4ae1e0
