...
Note that npm reports any failed script as exit code 1, even though we "exit 2"
  ...
  my-app:okay: cache miss, executing b5ccc48055a895cc
  my-app:okay: 
  my-app:okay: > okay
  my-app:okay: > echo 'working'
  my-app:okay: 
  my-app:okay: working
  my-app:error: cache miss, executing 8af6af970f510543
  my-app:error: 
  my-app:error: > error
...
Make sure error isn't cached
  ...
  \xe2\x80\xa2 Running error in 1 packages (esc)
  \xe2\x80\xa2 Remote caching disabled (esc)
  my-app:okay: cache hit, replaying output b5ccc48055a895cc
  my-app:okay: 
  my-app:okay: > okay
  my-app:okay: > echo 'working'
  my-app:okay: 
