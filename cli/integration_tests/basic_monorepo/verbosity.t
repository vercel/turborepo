...
Verbosity level 1
  ...
  util:build: cache bypass, force executing c154ed553992ff52
  util:build: 
  util:build: > build
...
Verbosity level 2
  ...
  [-0-9:.TWZ+]+ \[DEBUG] turbo: global hash: value=2e975be299f82c49 (re)
  ...
  [-0-9:.TWZ+]+ \[DEBUG] turbo: task hash: value=c154ed553992ff52 (re)
  util:build: cache bypass, force executing c154ed553992ff52
  util:build: 
  util:build: > build
  util:build: > echo 'building'
