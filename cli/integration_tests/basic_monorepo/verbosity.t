...
Verbosity level 1
  ...
  util:build: cache bypass, force executing eb1d222bd1029e49
  util:build: 
  util:build: > build
...
Verbosity level 2
  ...
  [-0-9:.TWZ+]+ \[DEBUG] turbo: global hash: value=4de72aa57fdfb7f7 (re)
  ...
  [-0-9:.TWZ+]+ \[DEBUG] turbo: task hash: value=eb1d222bd1029e49 (re)
  util:build: cache bypass, force executing eb1d222bd1029e49
  util:build: 
  util:build: > build
  util:build: > echo 'building'
