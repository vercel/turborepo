...
Verbosity level 1
  ...
  util:build: cache bypass, force executing 620c1a1e50209cea
  util:build: 
  util:build: > build
...
Verbosity level 2
  ...
  [-0-9:.TWZ+]+ \[DEBUG] turbo: global hash: value=81c037988a0673c5 (re)
  ...
  [-0-9:.TWZ+]+ \[DEBUG] turbo: task hash: value=620c1a1e50209cea (re)
  util:build: cache bypass, force executing 620c1a1e50209cea
  util:build: 
  util:build: > build
  util:build: > echo 'building'
