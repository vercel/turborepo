...
Verbosity level 1
  ...
  util:build: cache bypass, force executing 22f473772606ba7c
  util:build: 
  util:build: > build
...
Verbosity level 2
  ...
  [-0-9:.TWZ+]+ \[DEBUG] turbo: global hash: value=a9823fe2693112d5 (re)
  ...
  [-0-9:.TWZ+]+ \[DEBUG] turbo: task hash: value=22f473772606ba7c (re)
  util:build: cache bypass, force executing 22f473772606ba7c
  util:build: 
  util:build: > build
  util:build: > echo 'building'
