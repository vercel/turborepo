...
// RelativeTo calculates the relative path between a AbsoluteUnixPath and any other UnixPath.
func (p AbsoluteUnixPath) RelativeTo(basePath UnixPathInterface) (RelativeUnixPath, error) {
