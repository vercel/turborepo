...
type OutputWatcher interface {
	...
	GetChangedOutputs(ctx context.Context, hash string, repoRelativeOutputGlobs fs.TaskOutputs) (fs.TaskOutputs, error)
...
func (NoOpOutputWatcher) GetChangedOutputs(ctx context.Context, hash string, repoRelativeOutputGlobs fs.TaskOutputs) (fs.TaskOutputs, error) {
