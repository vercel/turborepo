...
var INFO_PREFIX = color.New(color.Bold, color.FgBlue, color.ReverseVideo).Sprint(" INFO ") //nolint:golint,revive // TODO: don't use ALL_CAPS in Go names; use CamelCase
