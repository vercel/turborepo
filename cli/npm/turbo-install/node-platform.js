...
export var ESBUILD_BINARY_PATH = process.env.ESBUILD_BINARY_PATH;

export const knownWindowsPackages = {
  "win32 arm64 LE": "esbuild-windows-arm64",
  "win32 ia32 LE": "esbuild-windows-32",
  "win32 x64 LE": "esbuild-windows-64",
};

export const knownUnixlikePackages = {
...
export function downloadedBinPath(pkg, subpath) {
