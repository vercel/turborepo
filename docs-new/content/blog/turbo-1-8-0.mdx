...
export const ogImage = "/images/blog/turbo-1-8-0/x-card.png";
...
With 1.8, `turbo` will automatically detect the workspace you are in and generate [the `--filter` syntax](/repo/docs/reference/command-line-reference/run#--filter) to scope your task to that workspace.
