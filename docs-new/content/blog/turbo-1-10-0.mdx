...
export const date = "2023/06/01";
export const tag = "web development";
export const ogImage = "/images/blog/turbo-1-10-0/x-card.png";
...
<Callout>
  ...
  [env](/repo/docs/core-concepts/caching/environment-variable-inputs#pipelinetaskenv),
  or
  [globalEnv](/repo/docs/core-concepts/caching/environment-variable-inputs#globalenv)
  to ensure they are included in your hash.
</Callout>
