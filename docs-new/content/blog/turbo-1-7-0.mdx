...
export const date = "2023/01/11";
export const tag = "web development";
export const ogImage = "/images/blog/turbo-1-7-0/x-card.png";
...
This can be used as a [configuration option](/repo/docs/reference/configuration#outputmode) or as a [CLI flag](/repo/docs/reference/command-line-reference/run#--output-logs)
