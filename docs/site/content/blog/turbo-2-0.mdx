...
- **Licensing and maintenance updates**: Upgraded to MIT license and added [Long Term Support policy](/repo/docs/getting-started/support-policy#lts-policy)

Update today by running `npx @turbo/codemod migrate` or get started with `npx create-turbo@latest`.

Visit [the upgrading guide](/repo/docs/crafting-your-repository/upgrading#upgrading-to-20) for update instructions. [Breaking changes](#breaking-changes) are listed below.
...
To learn more about persistent and interactive tasks, [visit the documentation](/repo/docs/reference/configuration#persistent).
...
[Visit the Turborepo documentation.](/repo/docs)

## Breaking changes

Visit [the upgrading guide](/repo/docs/crafting-your-repository/upgrading#upgrading-to-20) for instructions on how to update to 2.0.
...
- Minimum package manager version support for npm and pnpm updated to 8 ([Source](/repo/docs/getting-started/support-policy#package-managers))
