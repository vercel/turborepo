...
Yarn’s 4.10.0 release introduced “catalogs”, inspired by [pnpm’s catalogs feature](https://pnpm.io/catalogs). Catalogs allow you to define a specific version of a dependency once, and reuse that version as a constant in the rest of your repository.
