...
<Date>Wednesday, December 17th, 2025</Date>
...
We’ve expanded the capabilities of [Package Configurations](https://turborepo.com/docs/reference/package-configurations) so you can write your configuration once, and share it to anywhere in your repository.
...
[Visit the docs to learn more.](https://turborepo.com/docs/reference/package-configurations#extending-arrays-with-turbo_extends-pre-release)
...
Turborepo users love going fast, so its no surprise they enjoy using [Biome](https://biomejs.dev/) for linting and formatting. However, until today, the only linting support we had for finding unsafe environment variable usage was in ESLint, with [our `eslint-plugin-turbo` plugin](https://turborepo.com/docs/reference/eslint-plugin-turbo).

Now, you can find environment variables that can cause unexpected cache hits faster with [the new Turborepo domain](https://biomejs.dev/linter/domains/#turborepo) in Biome.
...
Once the rule is promoted out of the nursery group in a future release of Biome, the rule will be automatically activated for Turborepo projects, requiring zero-configuration.
...
[Visit our Support Policy](https://turborepo.com/docs/support-policy#package-managers) to learn more about our package manager support, or learn more about catalogs in [the Yarn documentation](https://yarnpkg.com/features/catalogs).

## Other changes

<Accordions>

  <Accordion title="Features (8)">
