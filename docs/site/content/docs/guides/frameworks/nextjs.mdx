...
<CopyPrompt
  ...
  prompt={
    "Set up a Next.js application in this Turborepo. 1) Create the initial app structure with create-next-app\n2) Configure internal package imports with the workspace protocol\n3) Set up proper turbo.json tasks for dev, build, and lint\n4) Briefly explain how Next.js caching interacts with Turborepo caching\n\nWalk me through each step with the specific commands and configuration needed for my package manager."
  }
/>
