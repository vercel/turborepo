...
This `package.json` installs TailwindCSS so we can create the file shared styles and export for the rest of the repository.
...
This file is small! It makes sure that TailwindCSS runs for the package.
