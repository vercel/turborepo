...
TODO: USE \<Files> TO MAKE A THING HERE
...
```ts title="./apps/my-app/src/index.ts"
  import { GRAVITATIONAL_CONSTANT, SPEED_OF_LIGHT_CONSTANT } from '@repo/math'
...
Now that you have a workspace set up, you can use your package manager to install dependencies into your packages to:

- Install useful external dependencies from the npm registry
- Create relationships between internal packages to share code easily in your repository
