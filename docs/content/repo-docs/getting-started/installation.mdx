...
You can continue to use your global installation of `turbo` to run commands. Global `turbo` will defer to the local version of your repository if it exists. This allows you to get the best of both worlds: easy scoping to the directory you're working in while maintaining a pinned version for consistent usage among your entire team.
...
active Node.js version on your system, but some features in the Turborepo ecosystem
