...
You can [create a blank workspace from scratch](/repo/docs/guides/generating-code#add-an-empty-workspace), [copy an existing workspace](/repo/docs/guides/generating-code#copy-an-existing-workspace), or even create custom generators
...
[Custom generators](/repo/docs/guides/generating-code#custom-generators) can also be used to scaffold more granular sets of code than workspaces. You can significantly speed up tasks like:
...
For more, check out the [documentation](/repo/docs/guides/generating-code).

## Improved Environment Variable Inputs

### Support for `.env` files

[`.env` files](https://www.dotenv.org/docs/) are commonly used to load environment variables. This can cause problems when running with `turbo`, because these variables can be [invisible](/repo/docs/crafting-your-repository/using-environment-variables#avoid-creating-or-mutating-environment-variables-at-runtime), and are not easily
...
<Callout>
  ...
  [env](/repo/docs/reference/configuration#env), or
  [globalEnv](/repo/docs/reference/configuration#globalenv) to ensure they are
  included in your hash.
</Callout>

For more, check out the [documentation](/repo/docs/reference/configuration#dotenv).
...
For more, check out the [documentation](/repo/docs/crafting-your-repository/using-environment-variables#wildcards).
...
In the new strict mode, when `turbo` is invoked with `--env-mode=strict`, only [important system environment variables](/repo/docs/reference/system-environment-variables) and environment variables enumerated inside of `turbo.json` will be made available to a task.

For more, check out the [documentation](/repo/docs/crafting-your-repository/using-environment-variables#environment-modes).
