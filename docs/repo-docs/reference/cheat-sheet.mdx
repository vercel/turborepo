...
| Current working directory         | [`--cwd`](/repo/docs/reference/run#--cwd)                                                                             | -                                                                                                                                                      | -                                                                                                                   |
| Streamed logs prefix              | [`--log-prefix`](/repo/docs/reference/run#--log-prefix)                                                               | -                                                                                                                                                      | -                                                                                                                   |
...
| Global inputs                     | [`--global-deps`](/repo/docs/reference/run#--global-deps)                                                             | -                                                                                                                                                      | [`globalDependencies`](/repo/docs/reference/configuration#globaldependencies)                                       |
...
| Behavior                      | Flags                                                                     | Environment Variables                                                                                  | turbo.json                                              |
| ----------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------- |
| Environment variable mode     | [`--env-mode`](/repo/docs/reference/run#--env-mode)                       | -                                                                                                      | [`envMode`](/repo/docs/reference/configuration#envmode) |
...
| Graph visualization | [`--graph`](/repo/docs/reference/run#--graph)         | -                                                                                          | -          |
| Dry run             | [`--dry`](/repo/docs/reference/run#--dry)             | -                                                                                          | -          |
