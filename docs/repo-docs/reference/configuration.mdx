...
### Task Dependencies [#globalDependencies]
...
### Environment Variables [#globalEnv]
...
#### Pass Through Variables [#globalPassThroughEnv]
...
The output from different tasks are streamed to your terminal.
...
#### Pass Through Variables [#passThroughEnv]
...
### Customise Output Logs [#outputLogs]
