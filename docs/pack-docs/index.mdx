...
Our team has taken the lessons from 10 years of webpack, combined with the innovations in incremental computation from [Turborepo](/repo/docs) and Google's Bazel, and created an architecture ready to support the coming decades of computing.
