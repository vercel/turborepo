...
By default, Turborepo caches the outputs of your tasks on your machine's local file system. We call this "single-player mode." But what if you could take advantage of the computational work done by your teammates or your CI? What if you could share a single cache across machines? A "Dropbox" for your Turborepo cache, if you will. In other words, what if you could turn on "co-op multiplayer mode"?
