...
We are planning to officially add code generation to `turbo` sometime this summer. In the meantime, we suggest using [plopjs/plop](https://github.com/plopjs/plop).
