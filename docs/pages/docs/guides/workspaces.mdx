...
To manage dependencies within workspaces from the root of your monorepo, run commands that only manage each workspace's dependencies rather than the entire monorepo.
