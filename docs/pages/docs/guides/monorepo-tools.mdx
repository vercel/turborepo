...
- [code-shaper/code-shaper](https://www.code-shaper.dev/) - Plugin-based code generation tool to scaffold applications and components. Builtin support for Turborepo. Off-the-shelf plugins for frameworks like React & Next.js, or write your own for custom patterns.
