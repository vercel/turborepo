...
We are planning to officially add code generation to `turbo` sometime in the future. In the meantime, we suggest using [Code Shaper](https://code-shaper.dev/) or [plopjs/plop](https://github.com/plopjs/plop).
