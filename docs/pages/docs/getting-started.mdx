...
Add [`turbo`](https://www.npmjs.com/package/turbo) as a development dependency in the root of your monorepo.
...
The `turbo` package is a shell script that will install the proper `turbo-<os>-<arch>` package for you operating system and architecture.
