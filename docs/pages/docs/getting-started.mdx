...
Turborepo works with [Yarn v1](https://classic.yarnpkg.com/lang/en/), [NPM](https://npmjs.com), and [PNPM](https://pnpm.io/) workspaces and [Node](https://nodejs.org/en/) v14 or higher. The `turbo` CLI works on the following operating systems.
...
The NPM version must be v7 or higher.
