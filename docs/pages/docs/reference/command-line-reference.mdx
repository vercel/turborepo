...
Instead of executing tasks, display details about the tasks that would be run.
Task details include the affected packages, commands to be run, log file locations, and more.
