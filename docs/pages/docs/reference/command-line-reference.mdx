...
Only applicable when remote artifact caching is configured. Enables sending a preflight request before every cache artifact and analytics upload. The follow-up upload will follow redirects.
