...
Default false. Do not replay cached logs of all tasks. This is useful for minimizing output in the terminal to only show what changed.

```shell
turbo run build --silence-cached-logs
```
