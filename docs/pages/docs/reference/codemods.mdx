...
description: To refactor large-scale codebases, Turborepo offers incredible codemod transformations and migration scripts every time some feature is removed.
---
