...
description: Turborepo shares a remote cache with your teammates and CI/CD for an additional speed boost. This is possible because it uses addressable content storage.
