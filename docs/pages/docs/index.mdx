...
Turborepo is a smart **task runner for JavaScript/TypeScript codebases**.

Your codebase's tasks - like `lint`, `build` and `test` - **don't run as fast as they could**. Turborepo uses [smart scheduling](/docs/core-concepts/running-tasks) and [caching](/docs/core-concepts/caching) to turbocharge your local setup and speed up your CI.
