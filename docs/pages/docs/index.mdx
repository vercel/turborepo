---
title: Documentation
description: Turborepo, developed by Jared Palmer and acquired by Vercel, offers a robust solution for JavaScript/TypeScript-based monorepos that stores all of your code and assets for every project.
---
