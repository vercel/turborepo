...
This will copy the root `package.json` and the and the root lockfile to the docker image. Then, it'll install dependencies, copy the app source and start the app.
...
Docker is pretty smart about how it deploys your apps. Just like Turbo, it tries to do as [little work as possible](http://bitjudo.com/blog/2014/03/13/building-efficient-dockerfiles-node-dot-js/).
