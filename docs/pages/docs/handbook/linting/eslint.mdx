...
Two things are notable here. First, the `main` field points to `index.js`. This allows files to easily [import this config](/docs/handbook/sharing-code/basics#anatomy-of-a-package).
...
We recommend following the setup in the [`basics`](/docs/handbook/linting/basics#running-tasks) section, with one alteration.
