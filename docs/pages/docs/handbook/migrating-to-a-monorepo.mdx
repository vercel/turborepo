...
Once your apps are in the right folder structure, you'll need to set up workspaces and install your dependencies. Our sections on [setting up workspaces](/docs/handbook/workspaces) should help.
...
1. How to set up [linting](/docs/handbook/linting)
