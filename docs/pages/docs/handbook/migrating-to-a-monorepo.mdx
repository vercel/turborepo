...
Once your apps are in the right folder structure, you'll need to think about their dependencies. Our section on [handling mismatched package versions](/docs/handbook/package-installation#handling-mis-matched-package-versions) should help.
