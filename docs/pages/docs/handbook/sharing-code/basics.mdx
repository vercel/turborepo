...
[**Internal** packages](/docs/handbook/sharing-code/internal) are intended to only be used inside the monorepo where they're housed. They are relatively simple to set up, and if your project is closed source they will be the most useful to you.

[**External** packages](/docs/handbook/sharing-code/external) are bundled and sent to a package registry. This is useful for design systems, shared utility libraries or any open source work. However, they introduce more complexity around bundling, versioning and publishing.
