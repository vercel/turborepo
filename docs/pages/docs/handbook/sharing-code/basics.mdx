...
This dual meaning can be very confusing to folks new to the monorepo scene. You're likely very familiar with [package installation](/docs/handbook/package-installation), but not so familiar with [workspaces](/docs/handbook/workspaces).
