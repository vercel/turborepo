...
description: A big thank you to all these developers, build systems, and monorepo tools for the immense support and help which made the development of Turborepo possible.
---
