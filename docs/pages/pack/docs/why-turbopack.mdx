...
There are two ways to make a process faster: do less work, and do work in parallel. We knew if we wanted to make the fastest bundler possible, we’d need to pull hard on both levers.
