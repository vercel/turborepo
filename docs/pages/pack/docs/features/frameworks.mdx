...
To begin with, Turbopack is focused on providing a great experience for the Next.js's dev server. We're using this as our initial goal to show what Turbopack can do. In the future, we want Turbopack to act as a low-level engine for other frameworks.
