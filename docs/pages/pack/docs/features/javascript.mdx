...
Top-level await lets you `await` functions at the module scope.
...
<Callout type="info">
  We're **planning** to provide **out-of-the-box support** for top-level await in Turbopack, but it isn't ready quite yet.
</Callout>
