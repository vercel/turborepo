...
is equivalent to the [filtering syntax](../core-concepts/monorepos/filtering):
...
collaborating with other developers](../core-concepts/remote-caching). In that case, add `turbo` as a dev dependency at the root
of the repository:
