...
You may prefer to make your workspaces responsible for owning their environment variables. This approach allows you greater flexibility if you don't mind the extra configuration overhead in your `package.json` scripts.
