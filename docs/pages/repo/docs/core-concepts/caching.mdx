...
For advanced use cases, you may need to account for operating systems (OS), architecture, or other external factors that you want to contribute to your hash. You can do this in four quick steps.
...
### 3. Add the file to `globalDependencies`

Now, we'll make sure that `turbo` is aware of the file by adding it to [`globalDependencies`](/repo/docs/reference/configuration#globaldependencies).
