...
<Callout type="error">
  ...
  [`--filter`](/repo/docs/core-concepts/filtering#include-dependents-of-matched-packages)
  instead.
</Callout>
...
For more detailed information about the `--filter` flag and filtering, refer to the [dedicated page in our documentation](/repo/docs/core-concepts/filtering)
...
<Callout type="error">
  ...
  [`--filter`](/repo/docs/core-concepts/filtering#include-dependencies-of-matched-packages)
  instead.
</Callout>
...
<Callout type="error">
  ...
  [`--filter`](/repo/docs/core-concepts/filtering#filter-by-package) instead.
</Callout>
...
<Callout type="error">
  ...
  [`--filter`](/repo/docs/core-concepts/filtering#filter-by-changed-packages)
  instead.
</Callout>
