...
Turborepo has been acquired by [Vercel](https://vercel.com). With this announcement, **Vercel is open sourcing the `turbo` CLI and offering Remote Caching for free on all accounts during the transition period.**
...
If you are having difficulty upgrading please file an issue on GitHub. If you are having difficulty with your remote caching on Vercel, please reach out in [Discord](https://turborepo.org/discord)
