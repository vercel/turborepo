...
<Callout type="info">As of Next.js 13.1, you no longer need the `next-transpile-modules` package. For more information, visit the Next.js blog post [here](https://nextjs.org/blog/next-13-1#built-in-module-transpilation-stable).</Callout>
