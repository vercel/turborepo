...
Since releasing Turborepo v1.2 in late March, we've seen incredible adoption and community growth:

- 8k+ GitHub Stars
- 275k+ weekly NPM downloads
- 1,200+ members of the [Turborepo Community Discord](https://turborepo.org/discord)
- 5.5 years of compute time saved through Remote Caching on Vercel, saving +7 months per week now

Turborepo is the result of the combined work of over 120 contributors including our core team.

This release was brought to you by the contributions of: @gsoltis, @nathanhammond, @tknickman, @jaredpalmer, @zvictor, @ObliviousHarmony, @O4epegb, @rafaeltab, @mcmontseny, @bertspaan, @Jastor11, @enBonnet
