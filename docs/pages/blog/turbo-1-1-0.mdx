...
- `transform` - the name of transform, [see available transforms in the docs](/docs/reference/codemods#turborepo-1x).
- `path` - files or directory to transform.
- `--dry` - Do a dry run, no code will be edited.
- `--print` - Prints the changed output for comparison.

For more information about specific transforms, check out the [new Codemods documentation](/docs/reference/codemods#turborepo-1x).
...
For more information on this transformation, [check out the documentation](/docs/reference/codemods#create-turbo-config).
...
For more information on this transformation, [check out the documentation](/docs/reference/codemods#add-package-manager).
...
You can now control `turbo`'s [cache fingerprinting (a.k.a. hashing)](/docs/core-concepts/caching#hashing) behavior based on the values of both environment variables and the contents of files:
...
For more information, read the [caching and hashing documentation](/docs/core-concepts/caching).
