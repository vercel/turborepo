...
- [**Rust port completed**](#shipping-an-all-rust-core): Finish the port from Go to lay groundwork for better performance, improved stability, and new features.
...
- [**Updated examples**](#updated-examples): Use one of the revitalized examples including Next.js, Svelte, Nuxt, and more.
...
Today, we're shipping an experimental version of Turbo LSP, helping you get the most out of Turborepo with in-editor tips like:
