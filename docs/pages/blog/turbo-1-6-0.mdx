...
You should use Turbo to run your `package.json` scripts. If you've got multiple scripts which all rely on each other, you can express them as Turbo tasks:
...
Turborepo will figure out the optimally fast path to run all of your tasks in parallel.
